...
<head>
  ...
  <title>FP References – CDP References</title>
  ...
  <style>
    ...
    .fileBadge.docx,
    .fileBadge.doc  { background: #2b6cb0; }
    .fileBadge.xlsx,
  ...
  <div class="app">
    ...
    <aside class="sidebar">
      <div class="filterWrap">
        ...
        <button type="button" class="filterBtn" onclick="location.href='FP_forms.php'" style="width:100%; margin-top:16px;">
          📄 Forms
        </button>

        <button type="button" class="filterBtn" onclick="location.href='FP_references.php'" style="width:100%; margin-top:16px; background:#4f7cdc; color:#fff;">
          📚 References
        </button>
      ...
      <div class="panel">
        ...
        <div class="panelTitleRow">
          ...
          <div style="display:flex; align-items:center; gap:12px; flex-wrap:wrap;">
            <div class="totalBadge"><?php echo count($refs); ?> file<?php echo count($refs) !== 1 ? 's' : ''; ?></div>
          </div>
        </div>

        <!-- Search -->
        <div class="searchWrap">
          <input id="searchBox" class="searchInput" type="text" placeholder="Search reference file name…" autocomplete="off" />
        ...
        <?php else: ?>
          ...
          <div class="emptyState" id="noResults" style="display:none;">No references match your search.</div>
        <?php endif; ?>
